...
const paymentTypeOptions = [
  { id: "membership_dues", name: "Membership Dues", description: "Monthly levy of ₦2,000" },
  { id: "donation", name: "Donation", description: "Voluntary contribution to the group" },
  { id: "event", name: "Event Payment", description: "Pay for an upcoming event" },
];

const recurringOptions = [
  { id: "true", name: "Recurring", description: "Set up an automatic monthly payment" },
...
export default function NewPayment({ events }: NewPaymentProps) {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<z.input<typeof initializePaymentSchema>, any, InitializePaymentSchemaType>({
  ...
  const onFormSubmit = (data: InitializePaymentSchemaType) => {
    fetcher.submit(
      { intent: "initialize-payment", ...data } as any,
      {
        method: "post",

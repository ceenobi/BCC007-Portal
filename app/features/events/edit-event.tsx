...
export default function EditEvent({
  ...
  // Only newly-uploaded replacement images are deleted client-side on
  // cancel/remove. The stored original is managed by the server (unset on
  // submit, never deleted just because the user closed the modal).

...
export default function HomeNav({ user }: { user?: SessionUser | null }) {
	...
	return (
		<header className="fixed top-0 w-full z-50 bg-white border-b backdrop-blur supports-backdrop-filter:bg-background/5 top-[env(safe-area-inset-top)]">
			<div className="px-4 sm:px-6 py-5 flex justify-between items-center">

...
const BRAND_ACCENT_SOFT = "bg-lightBlue/10 text-mainBlue dark:text-white";
						...
						{messages.length === 0 && !suggestions.length && (
							<div className="flex h-full flex-col items-center justify-center gap-2 text-center">
								...
								<p className="max-w-55 text-xs text-muted-foreground">
									I can look up your profile, check payment status, find events,
									and more — all in plain language.
								</p>
							</div>
						)}

	...
	return (
		<main className="py-10 pb-20 md:py-20 max-w-6xl mx-auto px-4">
			<div className="mt-20 grid grid-cols-1 md:grid-cols-12 gap-8">
				<div
					ref={leftCol.containerRef}
					className="col-span-1 md:col-span-7 space-y-6"
				>
					<h1
						style={leftCol.getItemStyle(0)}
						className={leftCol.getItemClassName(
							"italic text-foreground font-medium w-full max-w-152.5 sm:leading-none tracking-tight text-[48px] lg:text-[4rem]",
						)}
					>
						Reach out
					</h1>
					<p
						...
						className={leftCol.getItemClassName(
							"w-full max-w-150 text-mainGray dark:text-muted-foreground leading-7",
						)}
					>
				...
				<div ref={rightCol.containerRef} className="col-span-1 md:col-span-5">
					<div
						...
						className={rightCol.getItemClassName(
							"sticky top-32 w-full max-w-125 p-6 rounded-xl dark:bg-lightGray border border-gray-200 dark:border-gray-700 hover:shadow space-y-6",
						)}
					>

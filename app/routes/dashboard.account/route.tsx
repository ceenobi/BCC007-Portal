        ...
        <Card className="dark:bg-lightGray p-0">
          <CardContent>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4 md:px-4 py-6 text-mainGray dark:text-muted-foreground">
              <div>
                <h2 className="font-medium text-mainBlack dark:text-white">Profile name</h2>
                <p className="text-sm">{user.name}</p>
              </div>
              <div>
                <h2 className="font-medium text-mainBlack dark:text-white">Role</h2>
                <p className="text-sm">{user.role}</p>
              </div>
              <div>
                <h2 className="font-medium text-mainBlack dark:text-white">Gender</h2>
                <p className="text-sm capitalize">{user.gender || "N/A"}</p>
              </div>
              <div>
                <h2 className="font-medium text-mainBlack dark:text-white">Birthday</h2>
                <p className="text-sm">
                  {new Date(user.dateOfBirth || "").toDateString() || "N/A"}
                </p>
              </div>
              <div>
                <h2 className="font-medium text-mainBlack dark:text-white">Joined Date</h2>
                <p className="text-sm">
        ...
        <Card className="dark:bg-lightGray p-0">
          <CardContent>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:px-4 py-6 text-mainGray dark:text-muted-foreground">
              <div>
                <h2 className="font-medium text-mainBlack dark:text-white">Email</h2>
                <p className="text-sm">{user.email}</p>
              </div>
              <div>
                <h2 className="font-medium text-mainBlack dark:text-white">Phone</h2>
                <p className="text-sm">{user.phone || "N/A"}</p>
              </div>
              <div>
                <h2 className="font-medium text-mainBlack dark:text-white">Occupation</h2>
                <p className="text-sm">{user.occupation || "N/A"}</p>
              </div>
              <div>
                <h2 className="font-medium text-mainBlack dark:text-white">Location</h2>

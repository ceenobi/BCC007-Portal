import { RiCheckboxCircleFill, RiUserForbidLine } from "@remixicon/react";
								...
								<div className="p-8 sm:p-12 text-center space-y-4">
									...
									<div className="space-y-3">
										...
										<p className="text-base text-muted-foreground">
											Your BCC007 account has been successfully deleted.
										...
										<div className="flex gap-4 text-left">
											...
											<div className="space-y-1">
												...
												<p className="text-xs text-muted-foreground">
													Your personal data and access have been removed. If
													you ever wish to return, you&apos;ll need to register

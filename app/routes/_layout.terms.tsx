...
export function meta(_args: Route.MetaArgs) {
	return [
		...
		webPageSchema({
			title: "Terms of Service - BCC007",
			description:
				"The terms and conditions governing use of the BCC007 alumni community platform.",
			path: "/terms",
		}),
	];
}
...
const sections: TermsSection[] = [
	{
		...
		body: [
			'These Terms of Service ("Terms") govern your access to and use of the BCC007 Group platform, including the website, dashboard and related services (collectively, the "Service"), operated by BCC007 ("we", "us" or "our") for the benefit of the BCC007 alumni community.',
	...
	},
	{
		...
		body: ["You agree not to misuse the Service, including by:"],
		items: [
				...
				<div ref={content.containerRef} className="lg:col-span-9 space-y-10">
					<header ref={header.containerRef} className="space-y-4">
						...
						<h1
							...
							className={header.getItemClassName(
								"italic text-foreground font-medium tracking-tight text-[40px] lg:text-5xl sm:leading-none",
							)}
						>
						...
						<p
							...
							className={header.getItemClassName(
								"text-mainGray dark:text-muted-foreground leading-7 max-w-2xl",
							)}
						>
